  ...
  <section class="main-code padding-lg">
    <div class="col-10 col-md-8 col-lg-10 d-flex flex-column justify-content-center mx-auto">
        ...
        <p class="">Mi chiamo Gianluca De Martino ed ho 29 anni. <br>
          ...
          Inoltre sono orgoglioso di dire che ho creato questo sito portfolio da zero ed oltre ad essere un modo per mettere in pratica le mie abilità spero che possa anche dimostrare le mie competenze e soprattutto <span class="fw-bold">la mia passione per questo mondo.</span>  <br>
